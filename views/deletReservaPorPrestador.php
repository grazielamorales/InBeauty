<?php 
    //página Cancelamento de reserva pelo Prestador
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="col md-auto">
                    <h3><em style="color:#ed563b; font-weight:bold"><?php echo $_SESSION['Nome']?></em>, tem certeza que deseja cancelar a reserva? </h3>
            ...
            ?>       
                ...
                <div class="col-6 mb-5" style="color:#198754">
                    <?php echo $msg;?>
                </div>       
            </div>
